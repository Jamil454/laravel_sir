                                ...
                                <div class="form-wrap">
                                    <form class="form-horizontal" method="post" action="{{route('specialist.store')}}">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputuname_3" class="col-sm-3 control-label">Specialist:*</label>
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    <div class="input-group-addon"></div>
                                                    <input type="text" name="specialist" class="form-control" id="exampleInputuname_3" placeholder="name">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
